        ...
        <div class="row">
            <div class="col-7">
                    <div class="card">
                        ...
                        <img src="{{asset('Front-end/img/Metode Pembayaran/bank-bri.jpg')}}" alt="" class="img-center" width="50%">
                        <div class="card">
                            <div class="card-body">
                                <p style="text-align:center;font-size:22px;font-weight:600;background-color: #dedede">223190876243513</p>
                            </div>
                        </div>
                        <hr>
                        <p>Cara melakukan pembayaran melalui Bank BRI :</p>
                        <ul>
                            <ol>1. Catat <b>No Rekening</b> yang ada diatas.</ol>
                            <ol>2. Pergilah ke ATM BRI Terdekat.</ol>
                            <ol>3. Lakukan pembayaran, dan anda akan menerima bukti terima pembayaran dari Bank BRI.</ol>
                            <ol>4. Kirim bukti pembayaran dari Bank BRI.</ol>
