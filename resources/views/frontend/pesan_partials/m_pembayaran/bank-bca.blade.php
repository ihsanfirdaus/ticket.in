    ...
    <div class="card">
        <div class="card-body">
            <p>Anda memilih metode pembayaran : <b>Bank BCA</b></p>
            <img src="{{asset('Front-end/img/Metode Pembayaran/bank-bca.jpg')}}" class="img-center" alt="" width="50%"><br>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                <a href="{{ url('pesan-tiket/konfirmasi-pembayaran-bca') }}"><button type="button" class="btn btn-info" style="float:right">Bayar</button></a>
                </div>
            </div>
        </div>
    </div>
